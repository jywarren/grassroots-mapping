...
2-3 people can map several square km in 1 day&Sorting photos can take \textgreater1 hour, stitching up to 1 day&Export from Cartagen Knitter generates a TMS or printable GeoTiff; all that's needed is web access.\\\bottomrule 
\end{tabularx}
\end{table}
