...
\begin{figure}[h]
  \begin{center}
    ...
    \caption{A system diagram of the OpenStreetMap, courtesy Iván Sánchez Ortega}
  \end{center}
\end{figure}
...
\begin{wrapfigure}{r}{0.5\textwidth}
	\begin{flushright}
		...
		\caption{César, a \ac{CEDRO} student, completes a kite of his own design in Juan Pablo II.}
	\end{flushright}
\end{wrapfigure}
...
use of diff GPS, better control points, ?
